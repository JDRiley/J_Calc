...
:j_calc_expression(irk_loc, i_left_expression->symbol_type()){
...
: j_calc_expression(std::move(irr_right)){
...
j_calc_expression& Binary_Expression::right_expression()const{
	return *M_right_expression;
}


j_calc_expression& Binary_Expression::left_expression()const{
