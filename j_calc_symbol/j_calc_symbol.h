...
public:
	...
	const jc_string_t& name()const;

	void set_name(const jc_string_t& irk_string);
	...
	virtual jc_string_t get_display_name();
...
protected:
	...
	j_calc_symbol* get_symbol_from_scope(const jc_string_t& irk_string)const;
private:
