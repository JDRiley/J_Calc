...
template<typename Key_t, typename Value_t, typename Comp_t, typename Alloc_t>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::const_iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::find(const Key_t& irk_key)const{
		return M_tree.find(irk_key);
	}


template<typename Key_t, typename Value_t, typename Comp_t , typename Alloc_t>
typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::iterator 
	j_map<Key_t, Value_t, Comp_t, Alloc_t>::find(const Key_t& irk_key){
		return M_tree.find(irk_key);
}
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::erase(const_iterator i_pos){
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::const_iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::cend()const{
		return M_tree.cend();
	}
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::const_iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::cbegin()const{
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::const_iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::end()const{
		return M_tree.end();
	}
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::const_iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::begin()const{
		return M_tree.begin();
	}
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::end(){
		return M_tree.end();
	}
...
template<
	typename Key_t, typename Value_t, typename Comp_t /*= std::less<Key_t>
	*/, typename Alloc_t /*= std::allocator<std::pair<Key_t, Value_t>>*/>
	typename j_map<Key_t, Value_t, Comp_t, Alloc_t>::iterator j_map<Key_t, Value_t, Comp_t, Alloc_t>::begin(){
		return M_tree.begin();
	}
